...
def tokenize_line(line):
    ...
    result = []
    # next_candidate_token cut the sentence to small pieces
    # and this method convert some of those pieces of text to true/false/nil/123
...
def tokenize_lines(input):
    ...
    input sequence."""
    # notice that the return value of mapping is not [] but an iterator
