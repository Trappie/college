...
# this Buffer class take 2d list's iterator as source, call current() or remove_front() to meet different requirement. and in the print(buf) will show all outputed tokends
...
class Buffer:
    ...
    """
    # it's interesting that the constructor of buffer only accept iter([[]]) as its source
    ...
    # by this method, the buffer object can read the source line by line efficiently
    def current(self):
